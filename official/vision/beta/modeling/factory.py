...
def build_ssd(
  ...
  isa_ratio = model_config.anchor.interpolated_scale_aspect_ratio
  ...
  head = dense_prediction_heads.SSDHead(
      ...
      num_classes=model_config.num_classes,
      num_anchors_per_location_list=[num_anchors_per_location
                                     for i in range(model_config.num_layers)],
      kernel_size=head_config.kernel_size,
      use_depthwise=head_config.use_depthwise,
      freeze_norm=head_config.freeze_norm,
      add_background_class=head_config.add_background_class,
      class_prediction_bias_init=head_config.class_prediction_bias_init,
      activation=norm_activation_config.activation,
      use_sync_bn=norm_activation_config.use_sync_bn,
      norm_momentum=norm_activation_config.norm_momentum,
      norm_epsilon=norm_activation_config.norm_epsilon,
  ...
  model = ssd_model.SSDModel(
      ...
      min_level=model_config.min_level,
      num_layers=model_config.num_layers,
      min_scale=model_config.anchor.min_scale,
      max_scale=model_config.anchor.max_scale,
      scales=model_config.anchor.scales,
      aspect_ratios=model_config.anchor.aspect_ratios,
      anchor_size=model_config.anchor.anchor_size,
      interpolated_scale_aspect_ratio=isa_ratio)
  return model
